...
export const EditGame = () => {
    ...
    const {onEditGame} = useContext(GameContext);
    ...
    useEffect(() => {
        gameService.GetById(gameId)
            .then(game => {
                ...
                formData.maxLevel = game.maxLevel;
                formData.imageUrl = game.imageUrl;
                formData.summary = game.summary;
            })
            .catch(() => {
                navigate('/');
            })
    ...
    const onSubmit = (e) => {
        ...
        gameService.EditGame(gameId, formData)
        .then(game => {
        ...
        <form id="create" onSubmit={onSubmit}>
            <div className="container">
                ...
                <input
                    ...
                    min={1}
                    placeholder={1}
                    defaultValue={formData.maxLevel}
                    onChange={onChange}
                ...
                <textarea name="summary" id="summary" onChange={onChange} onBlur={validateFieldsHandler} defaultValue={formData.summary}/>
