    ...
    return (
        <tr>
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={() => userActionHandler(user._id, actions.Edit)}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => userActionHandler(user._id, actions.Delete)}>
                ...
                <button className="btn info-btn" title="Info" onClick={() => userActionHandler(user._id, actions.Details)}>
